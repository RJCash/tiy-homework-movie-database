...
COPY movie (moviename, moviegenre, movie_id, column_3) FROM stdin;
John Wick	Action	1	\N
Shutter Island	Mystery	2	\N
Pulp Fiction	Crime	3	\N
The Conjuring	Horror	4	\N
The Green Mile	Drama	5	\N
\.
...
COPY movie_person (movie_personid, movieid, personid, new_column, column_5) FROM stdin;
1	1	3	\N	\N
2	2	2	\N	\N
4	3	4	\N	\N
5	4	5	\N	\N
...
SELECT pg_catalog.setval('person_person_id_seq', 6, true);
...
SELECT pg_catalog.setval('reviews_reviews_id_seq', 4, true);
